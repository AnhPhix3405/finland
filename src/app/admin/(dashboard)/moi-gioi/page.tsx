      ...
      <td className="px-6 py-4 text-right whitespace-nowrap">
        {is_active ? (
          <button 
            ...
            className="text-orange-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors p-1 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500" 
          ...
          >
            <span className="material-symbols-outlined text-lg" aria-hidden="true">lock_open</span>
          </button>
        )}
        <button 
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                {/* Mock rows */}
                {MOCK_BROKERS.map((b) =>
                  renderRow(b.id, b.full_name, b.phone, b.working_area, b.avatar_url, b.slug, b.is_active)
                )}
